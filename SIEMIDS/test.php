					...
					<div class="row">
							...
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div id="data" class="form-group col-xs-10 col-sm-10 col-md-10 col-lg-10">
										...
										<?php 
										 $getmac = "SELECT  `id`, `ip`, `title`,`dat_time` FROM `map`" ;
										...
										<div class="x_panel">
											<div class="x_content">
												<table id="datatable" class="table table-striped table-bordered">
														...
														<?php    
															$i = 1;
															while($getmac_row = mysqli_fetch_assoc($getmac_result)) {
															$ip = $getmac_row['ip'];
															$title = $getmac_row['title'];
															//$mace = $getmac_row[''];
															$description = $getmac_row['title'];
															$dat_time = $getmac_row['dat_time'];
